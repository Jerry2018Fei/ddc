...
)  AUTO_INCREMENT = 1139943693940281346 CHARACTER SET = utf8 COLLATE = utf8_bin ROW_FORMAT = Dynamic;
...
CREATE TABLE `ddc_admin`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
)  CHARACTER SET = utf8 COLLATE = utf8_bin ROW_FORMAT = Dynamic;
...
CREATE TABLE `ddc_authority`  (
  ...
  `del_flag` tinyint(2) NOT NULL DEFAULT 0 COMMENT '删除标志 0 未删除 1 已删除 默认 0',
  PRIMARY KEY (`id`) USING BTREE
)  AUTO_INCREMENT = 1139941081274761218 CHARACTER SET = utf8 COLLATE = utf8_bin ROW_FORMAT = Dynamic;
